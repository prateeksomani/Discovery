...
public class TestBase {
	...
	static {
		...
		extentReports = new ExtentReports(System.getProperty("user.dir") + "/src/main/java/ExecutionReport/test"
				+ dateFormat.format(calendar.getTime()) + ".html", false);// false reports will not be deleted
